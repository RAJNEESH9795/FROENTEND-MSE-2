...
export default function App() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return list;
  }, [searchQuery, priceRange, sortBy,category]);//Compare selected category with product.category and update filteredProducts
  ...
  function removeFromCart(id) {
    setCartItems(prev => prev.filter(i => i.id !== id));//Badge should count total quantities, not empty/static value
  }
