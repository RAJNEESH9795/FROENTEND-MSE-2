    ...
    <aside className="filters">
      ...
      <div className="filter-group">
        ...
        <select className="sort-select" value={sortBy} onChange={e => onSortChange(e.target.value)}>
          ...
          <option value="price-asc">Price: Low to High</option> // changed price-desc to price-asc for correct sorting order in the dropdown
          <option value="price-desc">Price: High to Low</option> // changed price-asc to price-desc for correct sorting order in the dropdown
